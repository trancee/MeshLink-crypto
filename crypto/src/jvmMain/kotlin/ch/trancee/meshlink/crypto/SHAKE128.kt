/*
 * JVM actual for SHAKE128 (ADR-0002).
 *
 ...
 *
 * On JDK 21, JCA does not provide a usable SHAKE128 provider in this library's
 * configuration — shake128Native returns null, so the pure-Kotlin path is always
