/*
 * Android actual for SHAKE256 (ADR-0002).
 *
 ...
 *
 * On Android API 21+, JCA does not provide a usable SHAKE256 provider —
 * shake256Native returns null, so the pure-Kotlin path is always taken
 * (ADR-0001, ticket 34).
 */
